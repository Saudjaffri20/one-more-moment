<?php $title = "ABC category";
include 'header2.php'; ?>


<div class="product-inner-pages mt-lg-5">
    <section class="purchased-product">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="row mb-5">
                        <div class="col-12">
                            <h2 class="gnrl-head inner-page-40">ABC Category</h2>
                            <div class="custm-txt-b"></div>
                        </div>
                    </div>
                    <div class="row mb-3 mb-xl-5">
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="prdct-box active">
                                <a href="#_">
                            ...
                            <div class="prdct-box">
                                <a href="#_">
                                    <div class="prdct-box-img">
                                        ...
                                        <p class="prdct-tag">Out Of Stock</p>
                                    </div>
                                    <h5>Cute Baby Toy's</h5>
                                    <div class="star">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
