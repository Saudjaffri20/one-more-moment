        ...
        <div class="container fade-in-column">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl-lg-5 ">
                    <p class="sign-error-txt mb-5"><i class="fa fa-exclamation" aria-hidden="true"></i> This email is blocked by the admin, please Contact Admin Here!</p>
                    ...
                    <form action="">
                        ...
                        <div class="form-field">
                            <a href="#_" class="login-btn-main">Sign In</a>
                        </div>
                    </form>
                </div>
            </div>
