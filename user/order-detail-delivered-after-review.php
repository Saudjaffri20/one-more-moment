      ...
      <div class="row">
                      ...
                      <table>
                        ...
                        <tbody>
                          <tr class="cart-row">
                            ...
                            <td>$ 00.00</td>
                            <td><button class="review-btn" data-target="#rating-review" data-toggle="modal">View Your Review</button></td>
                            <td>
                              <div class="dropdown ">
        ...
        <div class="col-md-6 col-lg-4 mt-4 mt-md-0">
          <div class="shipping-address">
            ...
            <div class="row align-items-center shipping-total px-3">
              <div class="col-sm-6 mb-2">
