                                    ...
                                    <div class="row align-items-end mb-2 mb-md-3">
                                        <div class="col-12">
                                            <div class="back-title">
                                                ...
                                                <h1 class="page-title text-capitalize">Order Details</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <div class="dashCard py-4 px-3">
                                                <form action="">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <h2 class="page-title-2 text-capitalize mb-2 mb-md-3 px-lg-2">Orders and Account</h2>
                                                            <hr class="m-0">
                                                        </div>
                                                            ...
                                                            <div class="px-lg-2">
                                                                ...
                                                                <div class="dashCard py-2 px-3 my-2 my-md-3">
                                                                    ...
                                                                    <div class="detailBox d-lg-flex align-items-baseline my-1">
                                                                        ...
                                                                        <div class="w-100">
                                                                            <select name="" id="" form="" class="site-select-c site-input-c maxw-250 pl-2">
                                                                                <option value="a" selected hidden disabled>Pending</option>
