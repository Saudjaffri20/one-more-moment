                                                        ...
                                                        <form action="">
                                                            <div class="userDetails">
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                    ...
                                                                    <input type="text" name="" id="" class="site-input-c pl-2" placeholder="Enter Title">
                                                                </div>
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                    <label for="" class="detail-label detail-label-lg">Starting Date<span class="text-danger">*</span>:</label>
                                                                    <input type="date" name="" id="" class="site-input-c maxw-250">
                                                                </div>
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                ...
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                    ...
                                                                    <input type="text" name="" id="" class="site-input-c pl-2" placeholder="Enter Promo Code">
                                                                </div>
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                ...
                                                                <div class="percentageInput">
                                                                    <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                        ...
                                                                        <input type="number" name="" id="" class="site-input-c pl-2" placeholder="Enter Percentage">
                                                                    </div>
                                                                </div>
                                                                <div class="amountInput">
                                                                    <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                        <label for="" class="detail-label detail-label-lg">Amount<span class="text-danger">*</span>:</label>
                                                                        <input type="text" name="" id="" class="site-input-c pl-2" placeholder="Enter Amount">
                                                                    </div>
                                                                </div>
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                ...
                                                                <div class="usageLimit mt-3">
                                                                    ...
                                                                    <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                        ...
                                                                        <input type="number" name="" id="" class="site-input-c pl-2" placeholder="Enter Usage Limit Per Coupon">
                                                                    </div>
                                                                    <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                        <label for="" class="detail-label detail-label-lg">Usage Limit Per Customer<span class="text-danger">*</span>:</label>
                                                                        <input type="number" name="" id="" class="site-input-c pl-2" placeholder="Enter Usage Limit Per Customer">
                                                                    </div>
                                                                    <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                        <label for="" class="detail-label detail-label-lg"></label>
                                                                        <button type="submit" class="site-btn px-5">Save</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
