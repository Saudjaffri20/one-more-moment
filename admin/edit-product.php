                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="back-title mb-2">
                                                            ...
                                                            <h2 class="page-title-2 text-capitalize">Edit</h2>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <form action="">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="detailBox my-2">
                                                                            ...
                                                                            <div class="media-image">
                                                                                <div class="ProductMediaBox d-flex align-items-end">
                                                                                    ...
                                                                                    <a href="" class="mediaDelete  ml-1 mr-2"><i class="fas fa-trash"></i></a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="detailBox my-2">
                                                                                <label for="b-image" class="detail-label d-block mb-2">Secondary Image</label>
                                                                                <div class="media-image d-flex flex-wrap flex-xl-nowrap">
                                                                                    <div class="ProductMediaBox d-flex align-items-end mb-2">
                                                                        ...
                                                                        <div class="col-lg-10">
                                                                            ...
                                                                            <div class="detailBox d-xl-flex align-items-baseline my-2">
                                                                                ...
                                                                                <div class="dashCard vDetail w-100 py-1 px-2">
                                                                                    <div class="v-row">
                                                                                        <div class="d-xl-flex">
                                                                                            <div class="detailBox d-lg-flex align-items-baseline my-1 mr-2 w-100">
                                                                                            ...
                                                                                            <div class="detailBox d-lg-flex align-items-baseline my-1 w-100">
