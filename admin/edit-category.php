                                    ...
                                    <div class="row align-items-end mb-2 mb-md-3">
                                        <div class="col-12">
                                            <div class="back-title">
                                                ...
                                                <h1 class="page-title text-capitalize">Edit Category</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                                            ...
                                                            <div class="userDetails">
                                                                ...
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                    ...
                                                                    <div class="dlt-input-p w-100">
                                                                        <div class="dlt-input w-100 position-relative">
                                                                ...
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                    ...
                                                                    <div class="detail-image-input d-lg-flex align-items-end">
                                                                        <div class="media-image">
                                                                            <div class="media-image-inner position-relative d-inline-block">
                                                                                <img src="images/img-detail.png" alt="" class="uploadedImage">
                                                                                <button>
                                                                                    <i class="fas fa-plus-circle"></i>
                                                                                </button>
                                                                            </div>
                                                                ...
                                                                <div class="detailBox d-lg-flex align-items-baseline my-2">
                                                                    ...
                                                                    <a class="site-btn px-5" data-toggle="modal" data-target="#editedCategory">Update</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
