...
<head>
  ...
  <title> One More Moment | <?php echo ((isset($title)) ? $title : 'Dashboard'); ?> </title>
...
<body class="vertical-layout vertical-menu 2-columns menu-expanded fixed-navbar <?php if ($title == "Login" || $title == "Register" || $title == "Error404") {
                                                                                  echo "pt-0";
                                                                                } else {
                                                                                  echo "";
