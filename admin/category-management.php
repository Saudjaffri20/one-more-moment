                                ...
                                <div class="card-dashboard">
                                    <div class="row align-items-end mb-2 mb-md-3">
                                        <div class="col-lg-6 mb-1">
                                            <h1 class="page-title text-capitalize">Category Management</h1>
                                        </div>
                                        <div class="col-lg-6 text-right mb-1">
                                            <a class="site-btn" href="add-category.php">Add New Category</a>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                                    <a class="dropdown-item" href="category-details.php">
                                                                                        <i class="far fa-eye"></i>View</a>
                                                                                    <a class="dropdown-item" data-toggle="modal" data-target="#inactiveCategory">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn transparent-btn ellipsis-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-ellipsis-v"></i></button>
                                                                                <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                                    <a class="dropdown-item" href="category-details-2.php">
                                                                                        <i class="far fa-eye"></i>View</a>
                                                                                    <a class="dropdown-item" data-toggle="modal" data-target="#activeCategory">
