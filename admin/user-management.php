                            ...
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row mb-2 mb-md-3">
                                        <div class="col-lg-6">
                                            <h1 class="page-title text-capitalize">User Management</h1>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                                    ...
                                                                                    <a class="dropdown-item" data-toggle="modal" data-target="#inactiveUser">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn transparent-btn ellipsis-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-ellipsis-v"></i></button>
                                                                                <div class="dropdown-menu text-left custom-dropdown" x-placement="bottom-start">
                                                                                    <a class="dropdown-item" href="user-details-2.php">
                                                                                        <i class="far fa-eye"></i>View</a>
                                                                                    <a class="dropdown-item" data-toggle="modal" data-target="#activeUser">
